...
try {
  ...
  console.log('      motor, acción libre, opciones, desenlaces, social, Umbral, desarrollo, desacople, las dos aventuras, el encadenado, la creación, el criterio de tiradas y la auditoría de alcanzabilidad en verde');
